...
public class PaymentsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = paymentObj.insertPayment(request.getParameter("payment_code"), 
				 						   request.getParameter("customer_id"), 
				 						   request.getParameter("month_of_bill"), 
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request); 
		 String output = paymentObj.updatePayment(paras.get("hidPaymentIDSave").toString(), 
				 							paras.get("payment_code").toString(), 
				 							paras.get("customer_id").toString(), 
				 							paras.get("month_of_bill").toString(), 
